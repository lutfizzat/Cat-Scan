...
namespace DigitalRubyShared
{
    ...
    public class FingersImageGestureHelperComponentScript : ImageGestureRecognizerComponentScript
    {
        ...
        private void UpdateLines()
        {
            ...
            {
                Vector3 worldPos = new Vector3(Gesture.FocusX, Gesture.FocusY, 0.0f); // Set initial z-coordinate to 0.0f
                worldPos = Camera.main.ScreenToWorldPoint(worldPos);
                worldPos.z = -10; // Set your desired z-coordinate here
        ...
        public ImageGestureImage CheckForImageMatch(bool reset = true)
        {
            ...
            else
            {
                if (MatchText != null)
                {
                    ...
                    destroyer.DestroyPrefab(matchedImage.Name);
                }
